module.exports = [
  ...
  "If you could change your name (first, last, middle, or any combination of the three), what would you change and why?",
  ...
  'What does "holds water” mean to you?',
  ...
  "What are the truthmakers for statements of logical possibility?",
  "Do merely possible worlds exist?",
  "What sorts of things are possible worlds?",
  ...
  "Can there be aspects of reality that are in principle unknowable?",
  "Why is there something, rather than nothing?",
  "Could the world contain only dispositional properties?",
  "Can there be pure dispositional properties – that is, properties that have no categorical basis?",
  "What is time?",
  ...
  "Do laws of nature govern the occurrence of events in time?",
  "Are there laws of nature?",
  "What is causation?",
  "Is causation real, or an illusion?",
  "Could a cause succeed its effect?",
  "Could a cause and its effect be simultaneous?",
  "Are causal facts supervenient upon non-causal facts?",
  "Do causal relations between events presuppose causal laws?",
  "Is the world a deterministic one?",
  "What are persisting substances? Are they bundles of properties, or properties plus a substratum, or . . . ?",
  'What constitutes "identity over time"?',
  "Do objects perdure, or endure?",
  "Does the physical universe depend upon the existence of an immaterial creator?",
  "Is there a necessarily existent being upon which the contingent world depends for its existence?",
  "Could there be a person who was not in time?",
  "Can persons be analyzed in terms of person-stages?",
  "Is the self a bundle of experiences?",
  "Is the self a bundle of powers?",
  "Do humans involve immaterial souls?",
  "Do humans involve any properties that are not reducible to the properties that characterize the inanimate world?",
  "What is consciousness?",
  "What is intentionality? What is it for a mental state to be ‘about’ something?",
  "Could consciousness be a purely physical phenomenon?",
  "Could intentionality be a purely physical phenomenon?",
  "Are humans free?",
  "Is freedom compatible with determinism?",
  "Do humans possess libertarian free will?",
  "Is there such a thing as agent-causation?"
];
